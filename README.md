...
# My Repositories
`EPL133`: OOP course. The first group project of my BSc degree. Just a simple Java project.
`EPL342`: DataBase course. Electric Vehicle Funding Platform built with SQL and PHP.
`EPL343`: Software Engineering course. Inventory Tracker for Bars built with Flask (Python), SQLite, HTML (Jinja), CSS, JavaScript
`EPL499`: Natural Language Processing course. Sentiment Analysis using a logistic regression model.
